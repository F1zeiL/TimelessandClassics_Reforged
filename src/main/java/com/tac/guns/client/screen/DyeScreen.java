...
public class DyeScreen extends ContainerScreen<DyeContainer> {
    ...
    public DyeScreen(DyeContainer screenContainer, PlayerInventory playerInventory, ITextComponent titleIn) {
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        if ((this.minecraft.player.getHeldItemMainhand().getItem() instanceof ScopeItem) ||
            ...
            for (int i = 0; i < 3; i++) {
                ...
                } else if (i == 0 && this.weaponInventory.getStackInSlot(i).isEmpty()) {
                    this.blit(matrixStack, left + 70, top + 50 + 18, 176, 16, 16, 16);
                }
                if (i == 1 && !this.container.getSlot(i).isEnabled()) {
                    this.blit(matrixStack, left + 40, top + -1 + 18, 176, 0, 16, 16);
                } else if (i == 1 && this.weaponInventory.getStackInSlot(i).isEmpty()) {
                    this.blit(matrixStack, left + 40, top + -1 + 18, 176, 0, 16, 16);
                }
                if (i == 2 && !this.container.getSlot(i).isEnabled()) {
                    this.blit(matrixStack, left + 10, top + 50 + 18, 176, 32, 16, 16);
                } else if (i == 2 && this.weaponInventory.getStackInSlot(i).isEmpty()) {
                    this.blit(matrixStack, left + 10, top + 50 + 18, 176, 32, 16, 16);
                }
            }

...
public class ThrowableGrenadeEntity extends ThrowableItemEntity
{
    ...
    public ThrowableGrenadeEntity(World world, LivingEntity entity, int timeLeft, float power, float radius)
    {
    ...
    public void onDeath()
    {
        GrenadeEntity.createExplosion(this, this.power, this.radius * Config.SERVER.grenades.explosionRadius.get().floatValue(), null);
    }
}
